...
<node TEXT="PDO-00" LOCALIZED_STYLE_REF="AutomaticLayout.level.root" FOLDED="false" ID="ID_1090958577" CREATED="1409300609620" MODIFIED="1682878956372"><hook NAME="MapStyle" background="#2e3440" zoom="2.0">
...
<font BOLD="true"/>
<node TEXT="ОПИСАНИЕ КАРТЫ" LOCALIZED_STYLE_REF="defaultstyle.floating" POSITION="bottom_or_right" ID="ID_620432926" CREATED="1682878952416" MODIFIED="1682881060970" HGAP_QUANTITY="-176.99999 pt" VSHIFT_QUANTITY="-191.99999 pt">
<hook NAME="FreeNode"/>
<cloud COLOR="#f0f0f0" SHAPE="RECT"/>
<node TEXT="Совет-1:" ID="ID_1606200492" CREATED="1682878987151" MODIFIED="1682880952400">
<node TEXT="Чтобы открывались файлы по ссылке, например php, запусти пустым редактор и тогда по идее должны открываться" ID="ID_1694927382" CREATED="1682880957110" MODIFIED="1682881042467"/>
</node>
</node>
<node TEXT="// Конструкция без плейсхолдеров:&#xa;// $pdo-&gt;query($sql)&#xa;// Поскольку Здесь id уникальное то можно было использовать конструкцию без плейсхолдера" POSITION="bottom_or_right" ID="ID_506459368" CREATED="1682880616417" MODIFIED="1682880635477">
<font SIZE="14"/>
<node TEXT="файл с прмером кода" ID="ID_1589333805" CREATED="1682880669118" MODIFIED="1682880754485" LINK="k_PDO-00.php"/>
</node>
<node TEXT="// Конструкция с плейсхолдерами:&#xa;// $query = $pdo-&gt;prepare($sql);&#xa;// $query-&gt;execute([&apos;login&apos; =&gt; &apos;some&apos;])&#xa;// Выборка значения id и помещение его в переменную с использованием плейсхолдера :login" POSITION="bottom_or_right" ID="ID_183869482" CREATED="1682880599860" MODIFIED="1682880611215">
<font SIZE="14"/>
<node TEXT="файл с прмером кода" ID="ID_1836702736" CREATED="1682880669118" MODIFIED="1682880754485" LINK="k_PDO-00.php"/>
</node>
</node>
</map>
